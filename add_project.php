...
<html>
            ...
            <body class="">
                ...
                <ul id="videos" >
                    <li id="add_new_video" class="video_obj featured autoHeight columns twelve">
                        ...
                        <input name="project_name" type="text" placeholder="Project Name:" class="video_link columns twelve"/>
                        <a id="send_video_client" href="#" class="btn green columns three" onclick="document.getElementById('video_projects_add').submit();"><span>Add New Project</span> <i class="fa fa-send"></i></a>
                        </div>
