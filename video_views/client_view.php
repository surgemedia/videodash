...
//echo "SELECT * FROM video_under_project WHERE video_project_id = ".$project_id." AND enabling = 1 ORDER BY id DESC LIMIT 0, 1";
				...
				<ul>
					<li class="section contact five columns omega">
						...
						<form action="#" method="post">
							<input value="<?=$client_id;?>" name="client_id" type="hidden">
				...
				<form action="mail_upsell.php" id="addition_request_form" method="post" class="sixteen column">
					...
					<ul>
						<li class="video_obj featured">
							...
							<h1 class="title"><?php echo $cca_row['company_name'];?> - <?php echo $projectname_row['project_name']?> - <span><?php echo $last_video_under_project_row['version']; ?>  (<? echo check_deadline($project_id, $last_video_under_project_row['version']); ?>)</span>
							</h1>
